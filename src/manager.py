...
class Manager:
    ...
    def __init__(self, parameters: Parameters):
        ...
        """List of TenantBlacklistEntry objects."""
    ...
    def check_tenants_apartment_keys(self) -> bool:
        ...
        for tenant in self.tenants.values():
            """Check if the tenant's apartment key exists in the apartments data."""
    ...
    def get_apartment_costs(
        ...
        for bill in self.bills:
            """Calculate total costs for the apartment based on bills, optionally filtered by year and month."""
            if (
    ...
    def get_settlement(
        ...
        if total_cost is None:
            return None
        """Create and return an ApartmentSettlement object based on the total costs."""
    ...
    def create_tenants_settlements(
        ...
        """Create and return a list of TenantSettlement objects based on the apartment
        settlement and the tenants living in the apartment."""
    ...
    def get_debtors(self, apartment_key: str, year: int, month: int) -> list[str]:
        ...
        return output
        """Calculate and return a list of tenant names who are debtors based on their payments
        compared to their total due amounts for the given apartment, year, and month."""
